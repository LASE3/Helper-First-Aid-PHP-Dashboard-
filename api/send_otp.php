...
try {
    ...
    $insert = $pdo->prepare("
        INSERT INTO app_password_reset_otps
            (user_id, phone, otp_hash, expires_at, verified, created_at)
        VALUES
            (:user_id, :phone, :otp_hash, :expires_at, 0, NOW())
    ");
    ...
    /*
      ...
      OTP is NOT returned to Flutter.
      Check it in the database only if you need to test.
      For real SMS later, integrate an SMS provider here.
    */
